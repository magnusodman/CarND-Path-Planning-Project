...
std::vector<double> l_getXY(double s, double d, std::vector<double> maps_s, std::vector<double> maps_x, std::vector<double> maps_y)
{
  int prev_wp = -1;
...
std::tuple<std::vector<double>, std::vector<double>> trajectorygenerator::GenerateTrajectory(car ego, statemachine sm,  std::vector<double> previous_path_x, std::vector<double> previous_path_y, std::vector<double> map_waypoints_s,
  ...
  for(int wp_index = 0; wp_index < 3; wp_index++) {
    ...
    std::vector<double> next_wp = l_getXY(ego.s + (wp_index + 1) * wp_distance, (2+4*sm.lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);
